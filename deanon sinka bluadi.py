...
try:
    ...
    if os.sys.platform == "win32":
        ...
        os.system("clear") 
    exit('[!] пропишите pip install requests')
try:
    ...
    if os.sys.platform == "win32":
        ...
        os.system("clear")
    exit('[!] пропишите pip install bs4')
...
def receiving_data_ip():
    while True:
        try:
            ...
            fileD.close()
            print(f'\n{CYAN}{BOLD}[!] {RED}Всего лимитов 999 : {str(ip_data["limit"])}{RESET}')
...
def save():
    with open('dataFile.txt', 'a', encoding='utf-8') as fileD:
        ...
        try:
            ...
            pass
        fileD.write(f'\n[-] https://api.whatsapp.com/send?phone={str(number)}&text=Hello,%999this%999is%999NO-Blackmail - Поиск номера в  WhatsApp\n')
    ...
    try:
        ...
        try:
            ...
            if interNet == 0:
                ...
                print(f'{YELLOW}{BOLD}[1] {URL_L}{UNDERLINE}https://api.whatsapp.com/send?phone={str(number)}&text=Hello,%999this%999is%999No-BlackMail {RESET}- Поиск номера в  WhatsApp')
